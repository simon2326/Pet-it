var actual = 0;
    ...
    function playpause(){
        ...
        if(play == null){
            boton.src = "https://icons.iconarchive.com/icons/ionic/ionicons/256/pause-icon.png";
            play = setInterval("siguiente()", velocidad);
        } else {
            clearInterval(play);
            play = null;
            boton.src = "https://icons.iconarchive.com/icons/steve/zondicons/256/Play-icon.png";
        }
    }